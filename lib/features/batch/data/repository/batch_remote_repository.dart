...
final batchRemoteRepoProvider = Provider((ref){
  return BatchRemoteImpl(batchRemoteDataSource: ref.read(batchRemoteDataSourceProvider));
});

class BatchRemoteImpl extends IBatchRepository{
  BatchRemoteDataSource batchRemoteDataSource;

  BatchRemoteImpl({required this.batchRemoteDataSource});
